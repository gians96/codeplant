# FACTURADOR PRO - COMANDOS DOCKER - (ubuntu 20.04)
## Instalar el Facturador Pro (docker)
...
```sh
cd /var/
curl -O https://raw.githubusercontent.com/gians96/codeplant/master/facturador-pro/install.sh
chmod +x install.sh
